...
- (BOOL)targetKey:(NSString *)keyString IsExsitInJsonDictionary:(NSDictionary *) dict{
    if (!dict || ![dict isKindOfClass:[NSDictionary class]]) {
        ...
        return dict && [dict objectForKey:keyString] && ![[dict objectForKey:keyString] isKindOfClass:[NSNull class]];
    }
}

- (BOOL)objectIsTure:(NSString *) string AndDict:(NSDictionary *) dict
{
    return [dict objectForKey:string] && ![[dict objectForKey:string] isKindOfClass:[NSNull class]];
}
